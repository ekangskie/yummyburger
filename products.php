...
<div style="position: absolute; top: 20px; left: 80px;">
    <a href="maindashboard.php" class="order-btn">
    ...
    <div class="container-wrapper">
        <div class="container">
            <h1>Burgers</h1>
            <img src="images/4.png" alt="Delicious Burger" class="burger-img">
            <p>Experience the juiciest, most flavorful burger with fresh ingredients and a toasted bun.</p>
            <p class="price">₱5.99</p>
            <a href="burger_form.php" class="order-btn">Order Now</a>
        </div>

        <div class="container">
            <h1>Drinks</h1>
            <img src="images/3.png" alt="Delicious Burger" class="burger-img">
            <p>A delicious, healthy alternative packed with fresh vegetables and a crispy bun.</p>
            <p class="price">₱5.99</p>
            <a href="drinks.php" class="order-btn">Order Now</a>
        </div>

        <div class="container">
            <h1>Fries </h1>
            <img src="images/fries.png" alt="Delicious Burger" class="burger-img">
            <p>A fiery delight for spice lovers, topped with jalapeños and spicy sauce!</p>
            <p class="price">₱6.99</p>
            <a href="fries.php" class="order-btn">Order Now</a>
        </div>
    </div>
</body>
</html>
