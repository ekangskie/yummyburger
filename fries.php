...
if (isset($_POST['add_product'])) {
    ...
    if (!empty($product_image) && move_uploaded_file($product_image_tmp_name, $product_image_folder)) {
        $stmt = $conn->prepare("INSERT INTO `desserts`(name, price, image) VALUES (?, ?, ?)");
...
if (isset($_POST['add_to_cart'])) {
    ...
    if ($cart_query->num_rows > 0) {
        $message[] = 'Dessert already in cart!';
    } else {
...
<body>
    ...
    <div class="container">
        ...
        <div class="user-profile">
            ...
            if ($select_user && $select_user->num_rows > 0) {
    ...
    <i class="fas fa-fries"></i> dashboard

    <a href="index.php?logout=<?php echo $user_id; ?>" onclick="return confirm('Are you sure you want to logout?');" class="delete-btn">
    <i class="fas fa-sign-out-alt"></i> Logout</a>
        ...
        <!-- Products Section -->
        <div class="products">
            <h1 class="heading">Our Latest Fries</h1>
            <div class="box-container">
                <?php
                $select_product = $conn->query("SELECT * FROM `desserts`");
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><a href="Dessert.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('Are you sure to remove this?');">Remove</a></td>
                            </tr>
                    <?php
                        }
                    } else {
                    ...
                    <tr class="table-bottom">
                        ...
                        <td><a href="dashboard.php?delete_all" onclick="return confirm('Delete all from cart?');" class="delete-btn <?php echo ($grand_total > 0) ? '' : 'disabled'; ?>">Delete All</a></td>
                    </tr>
                </tbody>
            </table>
